...
const getWelcomeEmailContent = (language: string) => {
  if (language === 'de') {
    return {
      ...
      calculatorText: "Neugierig, was deine Backoffice-Arbeit tatsächlich kostet? Schau dir unseren <a href=\"https://www.l4yercak3.com/do-more-with-less\" style=\"color: #0066cc; text-decoration: underline;\">Do More With Less Rechner</a> an – er zeigt dir, wie viel Zeit (und Geld) dein Team für administrative Arbeit aufwendet und was sie stattdessen tun könnten.",
  ...
  return {
    ...
    calculatorText: "Curious what your back-office work is actually costing you? Check out our <a href=\"https://www.l4yercak3.com/do-more-with-less\" style=\"color: #0066cc; text-decoration: underline;\">Do More With Less calculator</a> – it shows you how much time (and money) your team spends on admin work, and what they could be doing instead.",
