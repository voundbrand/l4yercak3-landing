...
const getWelcomeEmailContent = (language: string) => {
  if (language === 'de') {
    return {
      ...
      calculatorText: "Neugierig, was deine Backoffice-Arbeit tatsächlich kostet? Schau dir unseren Do More With Less Rechner an – er zeigt dir, wie viel Zeit (und Geld) dein Team für administrative Arbeit aufwendet und was sie stattdessen tun könnten.",
  ...
  return {
    ...
    calculatorText: "Curious what your back-office work is actually costing you? Check out our Do More With Less calculator – it shows you how much time (and money) your team spends on admin work, and what they could be doing instead.",
